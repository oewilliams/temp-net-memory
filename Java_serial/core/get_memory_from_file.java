class get_memory_from_file {
    ...
    public static void main(String[] args) {
        ...
        String file_location = "/Users/oliverwilliams/Documents/qmul/Network_memory_project/release_builds/Java_working/test_data.txt";
        String separator = "\t";
        ...
        int order_est = memory_estimators.get_network_memory_EDC(edge_series, max_order, min_order);
